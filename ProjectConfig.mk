...
CUSTOM_HAL_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_HAL_MAIN_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
...
CUSTOM_MODEM = agold_lwctg_mp_4m_kewei
...
AGOLD_LAUNCHER_CYCLE_SLIDING_SUPPORT = no
AGOLD_APP_FACTORY_DEFAULT = no
AGOLD_ADD_SYSTEM_GESTURE_SETTINGS = no
...
AGOLD_APP_MUSIC_FOR_KW = yes
AGOLD_APP_MUSIC_DEFAULT = no
...
AGOLD_DISABLE_TP_FILTER = yes
AGOLD_APP_DIALER_FOR_KW = no
AGOLD_DUAL_MIC_SUPPORT = yes
AGOLD_APP_FACTORY_KW = yes
AGOLD_SHUTDONW_DAILOG_AIRPLANE = yes
AGOLD_SHOW_NAV_BAR = yes
AGOLD_REAL_NAV_SWITCH_KW = yes
AGOLD_REAL_NAV_SWITCH_NAV_KW = yes
AGOLD_DEFAULT_BUILD_VERNO = no
AGOLD_PROFILE_SOUND_EFFECT_ENABLED = yes
AGOLD_KEYBOARD_TOUCH_AUDIO_EFFECT = no
AGOLD_DX_ANIMATION = no
AGOLD_NEW_LED_SUPPORT = yes
AGOLD_NOT_BUILD_BOOTANIMATION = yes
AGOLD_FINGERPRINT_SUPPORT = yes
AGOLD_FINGERPRINT_MICROARRAY = yes
AGOLD_NOT_BUILD_BOOTAUDIO = yes
AGOLD_SUPPORT_FLASHLIGHT = yes
AGOLD_PHONE_AUTO_TIME = yes
AGOLD_PHONE_AUTO_TIME_ZONE = yes
AGOLD_KEYGUARD_PIN_UNLOCK_AUTO = yes
AGOLD_USE_REFMIC_IN_LOUDSPK = yes
AGOLD_BUILD_GMS_FOR_KW = yes
AGOLD_BUILD_GMS_FOR_KW_GMS = no
AGOLD_SECURITY_FOR_KW = yes
AGOLD_DEF_SYSSTAS_FOR_KW_U1 = yes
AGOLD_REMOVE_CALIBRATION_ACC = yes
AGOLD_REMOVE_CALIBRATION_ALPS = yes
AGOLD_BOOT_UP_VIBRATOR = yes
AGOLD_WIDGET_TRANS_KW = yes
AGOLD_TRACKCLEAR_ENABLE = no
AGOLD_SHORTCUT_ENABLE = yes
AGOLD_SMALL_SUSPEND_WINDOW_KW = yes
AGOLD_CAMERA_REMOVE_AIS = yes
AGOLD_CAMERA_REMOVE_EIS = yes
AGOLD_DEFAULT_MIRACKETEK_KW = yes
AGOLD_BATTERY_SAVER_ENABLE = yes
...
AGOLD_LCM_LIST = B55027X2NA XL0553250B1
AGOLD_IMGSENSOR_LIST = gc5005_mipi_raw imx219_mipi_raw mn34152_mipi_raw  imx230_mipi_raw s5k3l8_mipi_raw
AGOLD_TP_LIST = GT1X
MTK_INCALL_NORMAL_DMNR = yes
AGOLD_DEFAULT_SHORTCUT_URI = AGOLD_EMPTY
AGOLD_WEEK_START_DAY_DEFAULT = -1
AGOLD_AUTO_BRIGHTNESS_DEFAULT_VALUE = 0
AGOLD_GALLERY_SCALE_IMAGE = 0.71f
AGOLD_GALLERY_SCALL_LIMITE = 1.5f
AGOLD_DEF_LOW_POWER_MODE_TRIGGER_LEVEL = 15
AGOLD_DEF_WALLPAPER = com.agold.launcher.wallpaper/wallpaper_home
...
AGOLD_LED_DEFAULT_COLOR_MMS = green
AGOLD_LED_DEFAULT_COLOR_CALL = red
AGOLD_LED_DEFAULT_COLOR_NOTIFICATION = blue
AGOLD_LED_DEFAULT_COLOR_CALLING = violet
AGOLD_DELETE_GMS_APK = SetupWizard
AGOLD_GPS_LOCATION_MODE = 3
AGOLD_DEF_CAMERA_ZSD_SUB = off
AGOLD_DEF_CAMERA_ZSD_MAIN = on
AGOLD_DEF_CAMERA_ANTIBAND_SUB = auto
AGOLD_DEF_CAMERA_MAIN_FLASH = off
AGOLD_DEF_CAMERA_FACE = on
AGOLD_SETTING_PHONE_TYPE = SUPER
AGOLD_PRODUCT_NAME = SUPER
AGOLD_PRODUCT_DEVICE_NAME = SUPER
AGOLD_BUILD_PRODUCT = SUPER
AGOLD_SETTING_PRODUCT_MANUFACTURER_NAME = UMI
AGOLD_SETTING_PRODUCT_BRAND_NAME = UMI
AGOLD_SETTING_MTK_BUILD_VERNO = UMI SUPER.V3.02
AGOLD_SETTING_WIFI_AP_NAME = UMI SUPER
AGOLD_DEFINE_USB_PRODUCT = UMI SUPER
AGOLD_BLUETOOTH_NAME = UMI SUPER
AGOLD_DEFAULT_WIFIP2P_DEVICENAME = UMI SUPER
AGOLD_USB_STORAGE_NAME = UMI_SUPER
AGOLD_PRODUCT_MODEL = UMI_SUPER
AGOLD_SETTING_KERNL_NAME = rom@91umi.com
AGOLD_SETTING_SCREEN_OFF_TIMEOUT = 30000
AGOLD_SETTING_TIMEZONE = Europe/London
AGOLD_DEFAULT_DATE_FORMAT = dd-MM-yyyy
AGOLD_DEFAULT_RING_TONE = BeatPlucker.ogg
AGOLD_DEFAULT_NOTIFY_TONE = Tinkerbell.ogg
AGOLD_GPS_LOCATION_SWITCH = network,gps
AGOLD_SETTING_BROWER_HOMEPAGE = http://www.umidigi.com
CUST_APP = SysStats$P
AGOLD_MODEM_CONFIG = 
